...
In the 90s, Vim (Vi Improved) was created as an improvement to Vi and kind of a 2.0 version. Then in the 2010s, Neovim as an improvement to Vim with the main benefit in my opinion being the Lua configurations.
...
funky. For at least 20 years there has been a joke about "How do I exit Vim?" While this joke is goofy, it exists for a reason; Like a lot of things in Vim, exiting Vim is not intuitive. The Vim jokes are one of the many benefits of joining this community.

## My History with Vim

So Vim is something that's appealed to me pretty much as soon as I saw it. Even though it really interested me, I avoided it for a few years until one year I made it my goal to make it my primary editor or. Well I failed that year but the next year I got really good at
Vim and finally got my config completely working.

I'm really just trying to make the point that it's okay to give up or fail at Vim. I failed numerous times. I had to wipe my config and start from scratch like three times and I'm ashamed to say but there were many times I opened VS Code instead of Vim for working on my
projects. It took awhile to make it a priority for me and get comftorable with Vim. There's also a decent chance that Vim might just not be for you. As much as it pains me to say, some people just don't like it.
...
Vim has four primary modes (and some other modes I'm not really familiar with);
...
Switching between modes is confusing at first but once you get some momentum with it you'll be switching between the modes smooth as butter and developing much faster. The different modes are a big part of why you do not need to use your mouse. When I tell people
that you don't have to use your mouse when developing with Vim they look at me like I'm a crazy person but I promise it's awesome.
...
With all that being said, here are some of my favorite things about using Vim.

### 1. Vim is Fast

Alright so not all of the popular IDEs slowness is their fault. Sometimes communicating back and forth between an LSP and Client (the IDE) is just inherently slow and Vim can't make this miraculously faster. That being said Vim is one of the faster editors and even
when you add a lot of plugins it doesn't really chug like VS Code does for me.
...
1. It's faster and you keep your momentum. Taking your hands off your keyboard to move your mouse pointer is a lot slower than you would think. It can also mess with the Fung Shui of coding.
...
Okay I promise this section is different from **1. Vim is Fast**. This is about you being faster at coding using Vim.
...
### 6. HELP, I'M ON A LINUX SERVER AND I CAN'T OPEN NOTEPAD OR VS CODE

So even if you don't like Vim or prefer a different editor, I still think there's value in learning the basics as a lot of headless servers have only Vi/Vim or Nano as their default editor. Nano makes me nauseous and I will cry if you use Nano. So your only option is
Vi/Vim. I have some coworkers that hate everything Vim but they have to use Vi when they connect to their Linux server as it's the only editor availible.

## How I Would Start Learning Vim

Sink or swim as they say. I think the best way would be to watch a few short Youtube videos on the Vim basics, then have one coding project where you commit yourself to only building it with Vim. After you're comftorable with the basics, you can start looking at
plugins and fancy configurations. If you want to start with a default configuration, I would look into [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim)

## Jumping Around Files

For my personally, I fairly quickly reached a bout where I was comftorable editing my code with Vim. The thing that took me a long time to get the hang of switching between files in a project. I would save and quit vim then re open it in a new file. This was slow
...
me. I already mentioned this earlier but [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) is a great beginner config.
...
I DON'T KNOW. I'VE NEVER USED Emacs. Maybe I'm a hypocrite for not trying it out but I already love Vim so much. If despise Vim maybe you should try out Emacs, but to my understanding it's like comparing apples to oranges.
